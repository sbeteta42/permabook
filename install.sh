...
echo # - Sous Windows : executer CMD en mode Administrateur : ssh -L 80:127.0.0.1:80 user@<permabook_IP>
echo "
echo " - Ne fermer pas cette connexion SSH pendant la durée du TP ; le site web sera alors indisponible !"
